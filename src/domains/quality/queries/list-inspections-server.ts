...
import type { ListInspectionsFilter } from "./list-inspections";
...
export async function listInspectionsServer(
  ...
  if (error) throw new Error(`listInspectionsServer: ${error.message}`);
